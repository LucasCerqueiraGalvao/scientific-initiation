...
\texttt{keras.\allowbreak{}ops.\allowbreak{}nn.\allowbreak{}dot\_\allowbreak{}product\_\allowbreak{}attention} com backend TensorFlow & Scaled dot-product attention em framework independente & Documentacao Keras Ops + Vaswani et al. (2017) & Reutilizar os mesmos \texttt{Q}, \texttt{K}, \texttt{V} e mascara dos caminhos NumPy/PyTorch em tres casos deterministas. & Passou em \texttt{pytest} e na execucao canônica: 9/9 comparacoes aprovadas; maior erro absoluto \texttt{2.\allowbreak{}38418579e-07} para \texttt{atol=1e-6} e \texttt{rtol=1e-5}. & Aderente & Numerico/algoritmico \\
...
\texttt{torchao} v2 & Quantizacao e otimizacao nativa PyTorch & Documentacao oficial torchao & Quantizar camada linear pequena com \texttt{Int8\allowbreak{}Weight\allowbreak{}Only\allowbreak{}Config(version=2)} e verificar armazenamento interno. & Passou em \texttt{pytest}: camada roda sem warnings, peso e \texttt{Int8Tensor} e dados internos \texttt{qdata} usam \texttt{int8}. & Aderente & Numerico/algoritmico; hardware pendente \\
\bottomrule
\end{longtable}
\end{landscape}
