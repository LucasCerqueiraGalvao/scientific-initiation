...
Podemos concluir que a attention manual e sua composicao multi-head com projecoes Q/K/V/O estao matematicamente aderentes ao conceito e numericamente compativeis com APIs publicas de dois frameworks. A execucao v2 aprovou 18/18 comparacoes, com erro absoluto maximo de \texttt{4.\allowbreak{}76837158e-07} para \texttt{atol=1e-6} e \texttt{rtol=1e-5}.
