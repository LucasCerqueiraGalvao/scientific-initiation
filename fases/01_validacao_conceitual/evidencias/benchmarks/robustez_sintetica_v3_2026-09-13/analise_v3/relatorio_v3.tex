...
\section{Hipoteses}
\begin{itemize}
\item H1_H5: int8_vs_pruning_10 -- \texttt{sustentada}.
\item H1_H5: int8_vs_pruning_25 -- \texttt{sustentada}.
\item H1_H5: int8_vs_pruning_50 -- \texttt{sustentada}.
\item H1_H5: int8_vs_pruning_75 -- \texttt{sustentada}.
\item H6: mse_vs_sparsity -- \texttt{sustentada}.
\end{itemize}
\section{Limites}
