...
Caminhos fisicos e OPT & \statuspending & Requerem restaurar o daemon Docker, passar probe e smoke e executar as baterias fixadas no container Linux. \\
\bottomrule
\end{longtable}
...
prova aceleracao fisica; essa conclusao depende de kernels confirmados.
\end{icstatus}
