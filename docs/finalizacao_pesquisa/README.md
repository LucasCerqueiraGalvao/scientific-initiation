# Fechamento científico da pesquisa

Esta pasta registra a consolidação metodológica feita depois das baterias
principais. Ela não substitui os CSVs, manifestos ou o relatório LaTeX; serve
como guia curto para decidir os próximos experimentos sem misturar smoke,
diagnóstico histórico e resultado canônico.

Arquivos:

- [methodology.md](methodology.md): protocolo consolidado, níveis de evidência
  e fontes canônicas.
