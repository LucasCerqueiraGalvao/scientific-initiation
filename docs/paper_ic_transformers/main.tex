...
observada parcialmente: INT8 preservou perplexidade, enquanto pruning degradou
rapidamente conforme a sparsity aumentou.

Isso nao significa que INT8 ou pruning 2:4 sejam tecnicas ineficazes de modo
geral. A conclus\~ao correta e mais estreita: neste recorte, com estas entradas,
opera\c{c}\~oes isoladas, modelos OPT e GPU, nao houve speedup sustentado pelos
criterios completos. Essa leitura e importante para evitar extrapola\c{c}\~oes
indevidas a partir de benchmarks sinteticos ou de zeros logicos.
...
\RQ{7} & Nos OPT, INT8 preservou melhor qualidade que pruning; a degradacao de pruning cresceu com sparsity; speedup nao foi sustentado. \\
\RQ{8} & INT8 e 2:4 reduziram armazenamento e memoria com caminhos compativeis, mas nao latencia sustentada. \\
\bottomrule
\end{longtable}
...
parcialmente em modelos pre-treinados: INT8 preserva qualidade, pruning degrada
com sparsity, e redu\c{c}\~ao de representa\c{c}\~ao ou memoria nao garante
latencia menor.
